...
export default function HomePage() {
  ...
  const popularMovies = [
    ...
    { title: 'Oppenheimer', count: 2, year: 2023, image: 'https://image.tmdb.org/t/p/w780/fm6KqXpk3M2HVveHwCrBSSBaO0V.jpg', query: 'Oppenheimer' },
    { title: 'Breaking Bad', count: 2, year: 2008, image: 'https://image.tmdb.org/t/p/w780/tsRy63Mu5cu8etL1X7ZLyf7UP1M.jpg', query: 'Breaking Bad' },
    { title: 'Stranger Things', count: 2, year: 2016, image: 'https://image.tmdb.org/t/p/w780/56v2KjBlU4XaOv9rVYEQypROD7P.jpg', query: 'Stranger Things' },
    { title: 'The Last of Us', count: 1, year: 2023, image: 'https://image.tmdb.org/t/p/w780/uDgy6hyPd82kOHh6I95FLtLnj6p.jpg', query: 'The Last of Us' },
    { title: 'Fight Club', count: 2, year: 1999, image: 'https://image.tmdb.org/t/p/w780/hZkgoQYus5vegHoetLkCJzb17zJ.jpg', query: 'Fight Club' },
    { title: 'Dune: Part Two', count: 2, year: 2024, image: 'https://image.tmdb.org/t/p/w780/1pdfLvkbY9ohJlCjQH2CZjjYVvJ.jpg', query: 'Dune' },
    { title: 'The Boys', count: 2, year: 2019, image: 'https://image.tmdb.org/t/p/w780/n6bUvigpRFqSwmPp1m2YADdbRBc.jpg', query: 'The Boys' },
    { title: 'Blade Runner 2049', count: 1, year: 2017, image: 'https://image.tmdb.org/t/p/w780/gajva2L0rPYkEWjzgFlBXCAVBE5.jpg', query: 'Blade Runner' },
    { title: 'Whiplash', count: 1, year: 2014, image: 'https://image.tmdb.org/t/p/w780/7RyHsO4yDXtBv1zUU3mTpHeQ0d5.jpg', query: 'Whiplash' },
    { title: 'Arcane', count: 1, year: 2021, image: 'https://image.tmdb.org/t/p/w780/q8eejQcg1bAqImEV8jh8RtBD4uH.jpg', query: 'Arcane' },
    { title: 'Peaky Blinders', count: 1, year: 2013, image: 'https://image.tmdb.org/t/p/w780/3UupR0nS9R6Di9letdz4ftX95GF.jpg', query: 'Peaky Blinders' },
    { title: 'La La Land', count: 1, year: 2016, image: 'https://image.tmdb.org/t/p/w780/nlPCdZlHtRNcF6C9hzUH4ebmV1w.jpg', query: 'La La Land' },
  ];

  const popularCharacters = [
    { name: 'Estella / Cruella', media: 'Cruella', query: 'Estella' },
    { name: 'Bruce Wayne / Batman', media: 'The Batman', query: 'Bruce Wayne' },
    ...
    { name: 'Tyler Durden', media: 'Fight Club', query: 'Tyler Durden' },
    { name: 'Paul Atreides', media: 'Dune', query: 'Paul Atreides' },
    { name: 'Homelander / Butcher', media: 'The Boys', query: 'Homelander' },
    { name: 'Officer K', media: 'Blade Runner 2049', query: 'Officer K' },
